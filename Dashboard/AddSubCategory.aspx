<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard/Dashboard.Master" AutoEventWireup="true" CodeBehind="AddSubCategory.aspx.cs" Inherits="EyeConic_Solution.Dashboard.AddSubCategory" %>
                ...
                <div class="card-body">
                    ...
                    <div class="forms-sample">
                        <div class="form-group">
                            ...
                            <asp:DropDownList runat="server" CssClass="form-control" ID="ddlCategory" AutoPostBack="true" OnSelectedIndexChanged="DdlCategory_SelectedIndexChanged" style="color:black"></asp:DropDownList>
                        </div>
                        <div class="form-group">
