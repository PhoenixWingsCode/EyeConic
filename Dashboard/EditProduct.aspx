<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard/Dashboard.Master" AutoEventWireup="true" CodeBehind="EditProduct.aspx.cs" Inherits="EyeConic_Solution.Dashboard.EditProduct" %>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="forms-sample">
                        ...
                        <div class="form-group">
                            <label for="exampleInputName1" style="display:none">Your Selected Category</label>
                            <asp:TextBox runat="server" CssClass="form-control" ID="txtCategoryName" autocomplete="off" ReadOnly="true" Style="display:none"></asp:TextBox>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="exampleInputName1" style="display:none">Sub Category ID</label>
                        ...
                        <div class="form-group">
                            <label for="exampleInputName1" style="display:none">Your Selected Category Name</label>
                            <asp:TextBox runat="server" CssClass="form-control" ID="txtSubCategoryName" autocomplete="off" ReadOnly="true" Style="display:none"></asp:TextBox>
                        </div>
                        <div class="form-group">
